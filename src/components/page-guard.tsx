...
// Cattura gli errori di rendering delle pagine e mostra il messaggio reale al Project Manager
    ...
    try { return await page(props); }
      ...
      return (
        <div className="card mx-auto max-w-2xl p-6">
          ...
          <p className="mt-2 text-sm text-[var(--ink-2)]">I dati sono al sicuro. Riprova tra qualche istante; se succede ancora, segnala al Project Manager.</p>
